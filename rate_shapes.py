...
class ShockExp:
    def __init__(self, subj, amperage, export_dir = "/Users/Dan/Documents/shockbox_files/subject_files/shape_ratings", stimuli_dir = "/Users/Dan/Documents/shockbox_files/stimuli_art/", trial_dir = "/Users/Dan/Documents/shockbox_files/trials/trials"):
        self.subj = subj
    ...
    # generate_trials(n_trials=10, highest_threat_prob=.4, max_epochs_per_trial=6)
    ...
    def run_trial(self, trial_csv, escapable = True, shock = True, rating_frequency = 3, attn_frequency = 5, fixation_stim_time = 1, env_stim_time = 5, shock_stim_time = 0.1, set_coin_flip = None):
        ...
        log_df.to_csv(os.path.join(self.export_dir, f"{self.subj}_rate_shapes.csv"))

        print(f"circle rating = {self.anxiety_rating_history[0][0]}\nsquare rating = {self.anxiety_rating_history[-1][0]}")
...
x = ShockExp(subj='TA08152022', amperage=7) #SET AMPERAGE TO MAX TOLERATED DURING WORKUP
x.connect_device()
x.run_trial(trial_csv = "rate_shapes.csv", escapable = False, shock = True, rating_frequency = 1, attn_frequency = 0, fixation_stim_time = 1, env_stim_time = 5, shock_stim_time = 0.1, set_coin_flip = [["circle.png", "circle_shock.png", "no_escape_circle.png"], ["square.png", "square_shock.png", "no_escape_square.png"]])
